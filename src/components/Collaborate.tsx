...
export default function Collaborate() {
  ...
  return (
    <section id="collaborate" className="relative py-24 lg:py-32 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mx-auto reveal">
          <div className="relative glass rounded-2xl p-8 sm:p-10 text-center border border-cyan-400/15 overflow-hidden">
            ...
            <div className="relative">
              ...
              <button
                ...
                className="group inline-flex items-center gap-2 px-8 py-4 rounded-xl bg-cyan-400 text-navy-950 font-bold text-sm tracking-wide hover:bg-cyan-300 transition-all duration-200 shadow-lg shadow-cyan-400/20 hover:shadow-cyan-400/40"
              >
