    ...
    <section id="research" className="relative py-24 lg:py-32 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 max-w-4xl mx-auto reveal">
          <div className="glass rounded-2xl p-8 border border-cyan-400/10 text-center relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <h3 className="font-display font-bold text-white text-xl mb-3">Research Philosophy</h3>
